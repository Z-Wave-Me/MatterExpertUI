...
appController.controller('ExpertConfigController', function ($scope, $timeout,$interval, $location, cfg,dataService,deviceService) {
    ...
    $scope.loadSettings = function() {
        $scope.expertConfig.input = cfg.mattercfg;
    };
    $scope.loadSettings();
...
appController.controller('DataHolderController', function ($scope, $timeout,$interval, $location, cfg,dataService,deviceService) {
    ...
    function setControllerData(ZMatterAPIData) {
       $scope.dataHolder.controller.homeName = ZMatterAPIData.controller.data.homeName.value || cfg.controller.homeName;
       $scope.dataHolder.controller.homeNotes = ZMatterAPIData.controller.data.homeNotes.value.replace(/<br>/g, '\n' );
    }
