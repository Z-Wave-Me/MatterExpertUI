...
appFactory.factory('dataService', function ($http, $q, $interval, $filter, $location, $window, deviceService, myCache, cfg) {
    ...
    return({
        ...
        loadJoinedMatterData: loadJoinedMatterData,
        runMatterCmd: runMatterCmd,
        getApi: getApi,
    ...
    function loadZMatterApiData(noCache) {
        ...
        return $http({
            ...
            // something went wrong
            // do not return error here to still allow showing the list of Matter Bindings
            // return $q.reject(response);
        });
    }

    /**
     * Get updated data and join with MatterData
     */
    function  loadJoinedMatterData() {
        // console.trace('call');
