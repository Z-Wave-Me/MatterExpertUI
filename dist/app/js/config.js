...
var config_data = {
	'cfg': {
		...
		'dongle': 'zmatter', // Default dongle
		'dongle_list': [], // Dongle list

		// APIs with dongle
		'update_url': '/ZMatterAPI/Data/', // Url for update (refresh data)
		'store_url': '/ZMatterAPI/Run/', // Url for store data
		'restore_url': '/ZMatterAPI/Restore', // Url to restore backup
		'queue_url': '/ZMatterAPI/InspectQueue', // Url for inspect queue
		'fw_update_url': '/ZMatterAPI/FirmwareUpdate', // Url for Firmware Update
		'zme_bootloader_upgrade': '/ZMatterAPI/ZMEBootloaderUpgrade', // ZME Bootloader upgrade url
		'zme_firmware_upgrade': '/ZMatterAPI/ZMEFirmwareUpgrade', // ZME Firmware upgrade url
		'upload_bootloader': '/ZMatterAPI/ZMEBootloaderUpgrade', // Bootloader upload api
		'upload_firmware': '/ZMatterAPI/ZMEFirmwareUpgrade', // Firmware upload api
		'license_load_url': '/ZMatterAPI/ZMELicense', // Url to load new license
		'stat_url': '/ZMatterAPI/CommunicationStatistics', // Url to statistics
		'postfixget_url': '/ZMatterAPI/PostfixGet', // Postfix GET
		'postfixadd_url': '/ZMatterAPI/PostfixAdd', // Postfix Add
		'postfixremove_url': '/ZMatterAPI/PostfixRemove', // Postfix Remove
		'checklinks': '/ZMatterAPI/CheckAllLinks', // check link health
		'zniffer_url': '/ZMatterAPI/Zniffer', // Zniffer
		'zniffer_set_promisc_url': '/ZMatterAPI/Zniffer/SetPromisc/', // Zniffer Set Promiscuous Mode
		'communication_history_url': '/ZMatterAPI/CommunicationHistory', // Communication History
		'rssi_chart': '/ZMatterAPI/RSSIGet', // chart of rssi channels 1 and 2
		'call_all_nif': '/ZMatterAPI/CallForAllNIF', // Call niff for all devices
		'test_node': '/ZMatterAPI/TestNode/', // Test node command
		'network_statistics': '/ZMatterAPI/Run/', // Set time zone
		'post_report_api': '/ZMatterAPI/sendZWayReport', // Post report url
		'reorg_run_url': '/ZMatterAPI/NetworkReorganization', // Url to start reorganization
		'reorg_log_url': '/ZMatterAPI/GetReorganizationLog', // Url to load log
		'zddx_create_url': '/ZMatterAPI/CreateZDDX/', // Create zddx file
		'get_network_statistics': '/ZMatterAPI/GetStatisticsData', // get network statistics
		// 'get_dsk': '/ZMatterAPI/GetDSKCollection', // Get DSK collection,
		// 'remove_dsk': 'ZMatterAPI/RemoveDSKEntry?id=', // Remove DSK

		// Other APIs
		'packet_log': '/ZMatterAPI/PacketLog', // Get Packet log
		'clearPacketLog': '/ZMatterAPI/ClearPacketLog', // Reset Statistic
		'session': '/ZAutomation/api/v1/session',
		'matter_list': '/ZMatter/list', // Matter list of dongles
		...
		'encryptionKeys': '/ZMatterAPI/EncryptionKeys', // load image from automation storage
		...
		'matter_classes_url': 'storage/data/Matter_cmd_classes.xml', // Url to Matter Classes
		...
		'get_dsk': '/ZMatterAPI/GetDSKCollection', // Get DSK collection
		'add_dsk': '/ZMatterAPI/AddDSKEntry', // Add DSK
		'remove_dsk': '/ZMatterAPI/RemoveDSKEntry?dsk=', // Remove DSK
		'get_dsk_provisioning_list': '/ZMatterAPI/GetDSKProvisioningList', // Show ProvisioningList (includes only DSKs)
		'add_dsk_provisioning_list': '/ZMatterAPI/AddDSKProvisioningEntry?dsk=', // Add DSK to ProvisioningList (Response with added DSK) GET 
		'remove_dsk_collection': '/JS/Run/saveObject("zmatterdskCollection",null)', // Remove DSK collection
		'enable_smart_start': '/JS/Run/zmatter.SmartStartEnable()', // enable SmartStart
		...
		'smarthome_login': '/smarthome/#/?frommatterxpert', // Smarthome login page
